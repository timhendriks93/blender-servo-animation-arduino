...
{
    return this->receivedBytes[0] == START_MARKER && this->receivedBytes[LENGTH - 1] == END_MARKER;
}
...
{
    return this->receivedBytes[INDEX_POSITION_BYTE] | this->receivedBytes[INDEX_POSITION_SIG_BYTE] << BITS;
}